...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = val ->  {
    	Person intPerson = new Person();
    	intPerson.setFirstname("first_" + val);
    	intPerson.setLastname("last_" + val);
    	intPerson.setAge(val);
    	intPerson.setPassword("pass_"+val);
    	return intPerson;
    };
    // end::intToPerson[]
