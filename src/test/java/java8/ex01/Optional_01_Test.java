...
public class Optional_01_Test {
    ...
    public void test_optional_found() throws Exception {
        ...
        // TODO age == 10
        Optional<Person> result = Optional.ofNullable(find(personList,person -> person.getAge() == 10));
    ...
    public void test_optional_notfound_throw_exception() throws Exception {
        ...
        result.orElseThrow(() -> {throw new NotFountException();});
    }
    ...
    public void test_optional_notfound_with_default_value() throws Exception {
        ...
        Person result = Optional.ofNullable(find(personList, (Person person) -> person.getAge() == 400)).orElse(defaultValue);
